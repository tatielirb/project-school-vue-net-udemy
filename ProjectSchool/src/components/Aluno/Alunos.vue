...
export default {
  ...
  created() {
    if (this.professorid) {
      ...
      this.$http
        // .get(`localhost:3000/aluno/ByProfessor/${this.professorid}`)
  ...
  methods: {
    addAluno() {
      ...
      this.$http
        // .post("localhost:3000/aluno", _aluno)
    ...
    remover(aluno) {
      this.$http
        // .delete(`localhost:3000/aluno/${aluno.id}`)
    ...
    carregarProfessores() {
      this.$http
        // .get("localhost:3000/professor/" + this.professorid)
